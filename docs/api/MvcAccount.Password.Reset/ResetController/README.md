...
[Done][15]                                                                           | A page that informs the user that his password has been reset.                                                                                                                                                                
...
[Finish(String)][30]                                                                 | The reset password callback page.                                                                                                                                                                                             
[Finish(String, FinishInput)][31]                                                    | Attempts to reset the password.                                                                                                                                                                                               
...
[Reset()][88]                                                                        | The reset password page.                                                                                                                                                                                                      
[Reset(ResetInput)][89]                                                              | Attempts to reset the password.                                                                                                                                                                                               
[ToString][90]                                                                       | Returns a string that represents the current object. (Inherited from [Object][1].)                                                                                                                                            
[TryUpdateModel&lt;TModel>(TModel)][91]                                              | Updates the specified model instance using values from the controller's current value provider. (Inherited from [Controller][3].)                                                                                             
[TryUpdateModel&lt;TModel>(TModel, String)][92]                                      | Updates the specified model instance using values from the controller's current value provider and a prefix. (Inherited from [Controller][3].)                                                                                
[TryUpdateModel&lt;TModel>(TModel, String[])][93]                                    | Updates the specified model instance using values from the controller's current value provider and included properties. (Inherited from [Controller][3].)                                                                     
[TryUpdateModel&lt;TModel>(TModel, IValueProvider)][94]                              | Updates the specified model instance using values from the value provider. (Inherited from [Controller][3].)                                                                                                                  
[TryUpdateModel&lt;TModel>(TModel, String, String[])][95]                            | Updates the specified model instance using values from the controller's current value provider, a prefix, and included properties. (Inherited from [Controller][3].)                                                          
[TryUpdateModel&lt;TModel>(TModel, String, IValueProvider)][96]                      | Updates the specified model instance using values from the value provider and a prefix. (Inherited from [Controller][3].)                                                                                                     
[TryUpdateModel&lt;TModel>(TModel, String[], IValueProvider)][97]                    | Updates the specified model instance using values from the value provider and a list of properties to include. (Inherited from [Controller][3].)                                                                              
[TryUpdateModel&lt;TModel>(TModel, String, String[], String[])][98]                  | Updates the specified model instance using values from the controller's current value provider, a prefix, a list of properties to exclude, and a list of properties to include. (Inherited from [Controller][3].)             
[TryUpdateModel&lt;TModel>(TModel, String, String[], IValueProvider)][99]            | Updates the specified model instance using values from the value provider, a prefix, and included properties. (Inherited from [Controller][3].)                                                                               
[TryUpdateModel&lt;TModel>(TModel, String, String[], String[], IValueProvider)][100] | Updates the specified model instance using values from the value provider, a prefix, a list of properties to exclude , and a list of properties to include. (Inherited from [Controller][3].)                                 
[TryValidateModel(Object)][101]                                                      | Validates the specified model instance. (Inherited from [Controller][3].)                                                                                                                                                     
[TryValidateModel(Object, String)][102]                                              | Validates the specified model instance using an HTML prefix. (Inherited from [Controller][3].)                                                                                                                                
[UpdateModel&lt;TModel>(TModel)][103]                                                | Updates the specified model instance using values from the controller's current value provider. (Inherited from [Controller][3].)                                                                                             
[UpdateModel&lt;TModel>(TModel, String)][104]                                        | Updates the specified model instance using values from the controller's current value provider and a prefix. (Inherited from [Controller][3].)                                                                                
[UpdateModel&lt;TModel>(TModel, String[])][105]                                      | Updates the specified model instance using values from the controller object's current value provider. (Inherited from [Controller][3].)                                                                                      
[UpdateModel&lt;TModel>(TModel, IValueProvider)][106]                                | Updates the specified model instance using values from the value provider. (Inherited from [Controller][3].)                                                                                                                  
[UpdateModel&lt;TModel>(TModel, String, String[])][107]                              | Updates the specified model instance using values from the controller's current value provider, a prefix, and included properties. (Inherited from [Controller][3].)                                                          
[UpdateModel&lt;TModel>(TModel, String, IValueProvider)][108]                        | Updates the specified model instance using values from the value provider and a prefix. (Inherited from [Controller][3].)                                                                                                     
[UpdateModel&lt;TModel>(TModel, String[], IValueProvider)][109]                      | Updates the specified model instance using values from the value provider, a prefix, and a list of properties to include. (Inherited from [Controller][3].)                                                                   
[UpdateModel&lt;TModel>(TModel, String, String[], String[])][110]                    | Updates the specified model instance using values from the controller's current value provider, a prefix, a list of properties to exclude, and a list of properties to include. (Inherited from [Controller][3].)             
[UpdateModel&lt;TModel>(TModel, String, String[], IValueProvider)][111]              | Updates the specified model instance using values from the value provider, a prefix, and a list of properties to include. (Inherited from [Controller][3].)                                                                   
[UpdateModel&lt;TModel>(TModel, String, String[], String[], IValueProvider)][112]    | Updates the specified model instance using values from the value provider, a prefix, a list of properties to exclude, and a list of properties to include. (Inherited from [Controller][3].)                                  
[ValidateModel(Object)][113]                                                         | Validates the specified model instance. (Inherited from [Controller][3].)                                                                                                                                                     
[ValidateModel(Object, String)][114]                                                 | Validates the specified model instance using an HTML prefix. (Inherited from [Controller][3].)                                                                                                                                
[VerificationSent][115]                                                              | A page that informs the user that the reset password verification e-mail was sent.                                                                                                                                            
...
[30]: Finish.md
[31]: Finish_1.md
[32]: http://msdn.microsoft.com/en-us/library/zdee4b3y
[33]: http://msdn.microsoft.com/en-us/library/dfwy45w9
[34]: http://msdn.microsoft.com/en-us/library/42892f65
[35]: http://msdn.microsoft.com/en-us/library/dd492730
[36]: http://msdn.microsoft.com/en-us/library/gg453938
[37]: http://msdn.microsoft.com/en-us/library/gg402019
[38]: http://msdn.microsoft.com/en-us/library/gg402084
[39]: Initialize.md
[40]: ../../MvcAccount.Shared/BaseController/Initialize.md
[41]: http://msdn.microsoft.com/en-us/library/dd505087
[42]: http://msdn.microsoft.com/en-us/library/dd492253
[43]: http://msdn.microsoft.com/en-us/library/dd504936
[44]: http://msdn.microsoft.com/en-us/library/dd470569
[45]: http://msdn.microsoft.com/en-us/library/dd470169
[46]: http://msdn.microsoft.com/en-us/library/ee430920
[47]: http://msdn.microsoft.com/en-us/library/dd470587
[48]: http://msdn.microsoft.com/en-us/library/ee430918
[49]: http://msdn.microsoft.com/en-us/library/ee430908
[50]: http://msdn.microsoft.com/en-us/library/57ctke0a
[51]: http://msdn.microsoft.com/en-us/library/dd460283
[52]: http://msdn.microsoft.com/en-us/library/dd493080
[53]: http://msdn.microsoft.com/en-us/library/dd470545
[54]: http://msdn.microsoft.com/en-us/library/dd460532
[55]: http://msdn.microsoft.com/en-us/library/dd470615
[56]: http://msdn.microsoft.com/en-us/library/dd504998
[57]: http://msdn.microsoft.com/en-us/library/dd460345
[58]: http://msdn.microsoft.com/en-us/library/dd470537
[59]: http://msdn.microsoft.com/en-us/library/dd470145
[60]: http://msdn.microsoft.com/en-us/library/dd505247
[61]: http://msdn.microsoft.com/en-us/library/dd460161
[62]: http://msdn.microsoft.com/en-us/library/dd492671
[63]: http://msdn.microsoft.com/en-us/library/dd492890
[64]: http://msdn.microsoft.com/en-us/library/gg401950
[65]: http://msdn.microsoft.com/en-us/library/gg401978
[66]: http://msdn.microsoft.com/en-us/library/dd460241
[67]: http://msdn.microsoft.com/en-us/library/dd460291
[68]: http://msdn.microsoft.com/en-us/library/dd492939
[69]: http://msdn.microsoft.com/en-us/library/dd470594
[70]: http://msdn.microsoft.com/en-us/library/dd460311
[71]: http://msdn.microsoft.com/en-us/library/dd505283
[72]: http://msdn.microsoft.com/en-us/library/gg453902
[73]: http://msdn.microsoft.com/en-us/library/gg453883
[74]: http://msdn.microsoft.com/en-us/library/gg453920
[75]: http://msdn.microsoft.com/en-us/library/gg453904
[76]: http://msdn.microsoft.com/en-us/library/gg401893
[77]: http://msdn.microsoft.com/en-us/library/gg453864
[78]: http://msdn.microsoft.com/en-us/library/dd470174
[79]: http://msdn.microsoft.com/en-us/library/dd470199
[80]: http://msdn.microsoft.com/en-us/library/dd492497
[81]: http://msdn.microsoft.com/en-us/library/dd470522
[82]: http://msdn.microsoft.com/en-us/library/dd505024
[83]: http://msdn.microsoft.com/en-us/library/gg453870
[84]: http://msdn.microsoft.com/en-us/library/gg453933
[85]: http://msdn.microsoft.com/en-us/library/gg453941
[86]: http://msdn.microsoft.com/en-us/library/gg416644
[87]: http://msdn.microsoft.com/en-us/library/gg453955
[88]: Reset.md
[89]: Reset_1.md
[90]: http://msdn.microsoft.com/en-us/library/7bxwbwt2
[91]: http://msdn.microsoft.com/en-us/library/dd460189
[92]: http://msdn.microsoft.com/en-us/library/dd493137
[93]: http://msdn.microsoft.com/en-us/library/dd470377
[94]: http://msdn.microsoft.com/en-us/library/ee728634
[95]: http://msdn.microsoft.com/en-us/library/dd470908
[96]: http://msdn.microsoft.com/en-us/library/ee721265
[97]: http://msdn.microsoft.com/en-us/library/ee703530
[98]: http://msdn.microsoft.com/en-us/library/dd492957
[99]: http://msdn.microsoft.com/en-us/library/ee703635
[100]: http://msdn.microsoft.com/en-us/library/ee703452
[101]: http://msdn.microsoft.com/en-us/library/ff356143
[102]: http://msdn.microsoft.com/en-us/library/ff356144
[103]: http://msdn.microsoft.com/en-us/library/dd470933
[104]: http://msdn.microsoft.com/en-us/library/dd470808
[105]: http://msdn.microsoft.com/en-us/library/dd492193
[106]: http://msdn.microsoft.com/en-us/library/ee703656
[107]: http://msdn.microsoft.com/en-us/library/dd505127
[108]: http://msdn.microsoft.com/en-us/library/ee728613
[109]: http://msdn.microsoft.com/en-us/library/ee703486
[110]: http://msdn.microsoft.com/en-us/library/dd470388
[111]: http://msdn.microsoft.com/en-us/library/ee703664
[112]: http://msdn.microsoft.com/en-us/library/ee703509
[113]: http://msdn.microsoft.com/en-us/library/ff356131
[114]: http://msdn.microsoft.com/en-us/library/ff356138
[115]: VerificationSent.md
[116]: http://msdn.microsoft.com/en-us/library/dd460331
[117]: http://msdn.microsoft.com/en-us/library/dd505228
[118]: http://msdn.microsoft.com/en-us/library/dd492930
[119]: http://msdn.microsoft.com/en-us/library/dd460352
[120]: http://msdn.microsoft.com/en-us/library/dd460327
[121]: http://msdn.microsoft.com/en-us/library/dd470357
[122]: http://msdn.microsoft.com/en-us/library/dd470743
[123]: http://msdn.microsoft.com/en-us/library/dd460310
[124]: http://msdn.microsoft.com/en-us/library/dd470544
[125]: http://msdn.microsoft.com/en-us/library/dd492244
[126]: http://msdn.microsoft.com/en-us/library/dd505131
[127]: http://msdn.microsoft.com/en-us/library/dd492975
[128]: ../../MvcAccount.Shared/BaseController/Configuration.md
[129]: ../../MvcAccount/AccountConfiguration/README.md
[130]: http://msdn.microsoft.com/en-us/library/dd505205
[131]: http://msdn.microsoft.com/en-us/library/dd470552
[132]: http://msdn.microsoft.com/en-us/library/dd504944
[133]: http://msdn.microsoft.com/en-us/library/dd492753
[134]: http://msdn.microsoft.com/en-us/library/cc680816
[135]: http://msdn.microsoft.com/en-us/library/dd470578
[136]: http://msdn.microsoft.com/en-us/library/cc680930
[137]: http://msdn.microsoft.com/en-us/library/dd492210
[138]: http://msdn.microsoft.com/en-us/library/dd505016
[139]: http://msdn.microsoft.com/en-us/library/cc679943
[140]: http://msdn.microsoft.com/en-us/library/dd492995
[141]: http://msdn.microsoft.com/en-us/library/cc679805
[142]: http://msdn.microsoft.com/en-us/library/dd470383
[143]: http://msdn.microsoft.com/en-us/library/dd460181
[144]: http://msdn.microsoft.com/en-us/library/dd492973
[145]: http://msdn.microsoft.com/en-us/library/dd493019
[146]: http://msdn.microsoft.com/en-us/library/dd460533
[147]: http://msdn.microsoft.com/en-us/library/dd470838
[148]: http://msdn.microsoft.com/en-us/library/gg480763
[149]: http://msdn.microsoft.com/en-us/library/dd493086