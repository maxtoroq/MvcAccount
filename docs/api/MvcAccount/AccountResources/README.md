...
                                   | Name                                                | Description                                                                                                                                 
---------------------------------- | --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- 
![Public property]![Static member] | [Links_ChangeEmail][3]                              | Looks up a localized string similar to 'Change email address'.                                                                              
![Public property]![Static member] | [Links_ChangePassword][4]                           | Looks up a localized string similar to 'Change password'.                                                                                   
![Public property]![Static member] | [Links_Recovery][5]                                 | Looks up a localized string similar to 'Can't access your account?'.                                                                        
![Public property]![Static member] | [Links_ReturnToIndex][6]                            | Looks up a localized string similar to 'Go to My account'.                                                                                  
![Public property]![Static member] | [Links_SignIn][7]                                   | Looks up a localized string similar to 'Sign in'.                                                                                           
![Public property]![Static member] | [Links_SignOut][8]                                  | Looks up a localized string similar to 'Sign out'.                                                                                          
![Public property]![Static member] | [Model_ConfirmNewPassword][9]                       | Looks up a localized string similar to 'Re-enter new password'.                                                                             
![Public property]![Static member] | [Model_CurrentPassword][10]                         | Looks up a localized string similar to 'Current password'.                                                                                  
![Public property]![Static member] | [Model_Email][11]                                   | Looks up a localized string similar to 'Email'.                                                                                             
![Public property]![Static member] | [Model_EmailChangeNotificationMessageSubject][12]   | Looks up a localized string similar to 'Email change notification'.                                                                         
![Public property]![Static member] | [Model_EmailChangeVerificationMessageSubject][13]   | Looks up a localized string similar to 'Email change verification'.                                                                         
![Public property]![Static member] | [Model_NewEmail][14]                                | Looks up a localized string similar to 'New email address'.                                                                                 
![Public property]![Static member] | [Model_NewPassword][15]                             | Looks up a localized string similar to 'New password'.                                                                                      
![Public property]![Static member] | [Model_Password][16]                                | Looks up a localized string similar to 'Password'.                                                                                          
![Public property]![Static member] | [Model_PasswordResetVerificationMessageSubject][17] | Looks up a localized string similar to 'Password Assistance'.                                                                               
![Public property]![Static member] | [Model_RememberMe][18]                              | Looks up a localized string similar to 'Stay signed in'.                                                                                    
![Public property]![Static member] | [Model_Username][19]                                | Looks up a localized string similar to 'Username'.                                                                                          
![Public property]![Static member] | [Validation_CurrentPasswordIncorrect][20]           | Looks up a localized string similar to 'The {1} is incorrect.'.                                                                             
![Public property]![Static member] | [Validation_EmailAlreadyExists][21]                 | Looks up a localized string similar to 'User with email '{0}' already exists.'.                                                             
![Public property]![Static member] | [Validation_EmailPattern][22]                       | Looks up a localized string similar to 'The {0} is invalid.'.                                                                               
![Public property]![Static member] | [Validation_MaxInvalidSignInAttempts][23]           | Looks up a localized string similar to 'You have reached the max. number of invalid attempts, you can try again in {0} minutes.'.           
![Public property]![Static member] | [Validation_MissingEmail][24]                       | Looks up a localized string similar to 'We don't have your email address in our records, your request cannot be completed.'.                
![Public property]![Static member] | [Validation_MissingPasswordCannotAuthenticate][25]  | Looks up a localized string similar to 'Cannot authenticate.'.                                                                              
...
![Public property]![Static member] | [Views_Password_Reset_Finish_Message][50]           | Looks up a localized string similar to 'Select your new password and enter it below.'.                                                      
