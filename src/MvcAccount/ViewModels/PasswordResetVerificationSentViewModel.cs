...
namespace MvcAccount.ViewModels {
   ...
   public class PasswordResetVerificationSentViewModel : BaseViewModel {
      ...
      /// <summary>
      /// Initializes a new instance of the <see cref="PasswordResetVerificationSentViewModel"/> class.
      /// </summary>
      public PasswordResetVerificationSentViewModel() {
         this.Title = AccountResources.Views_PasswordResetVerificationSent_Title;
      }

      internal PasswordResetVerificationSentViewModel(ResetPasswordResult result) 
         : this() {
