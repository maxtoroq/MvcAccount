...
namespace MvcAccount.ViewModels {
   ...
   public class PasswordSavedViewModel : BaseViewModel {
      ...
      /// <summary>
      /// Initializes a new instance of the <see cref="PasswordSavedViewModel"/> class.
      /// </summary>
      public PasswordSavedViewModel() {
         ...
         this.NextLink = new LinkModel(this.Url.Action(""), AccountResources.Views_GoTo.FormatInvariant(AccountResources.Links_Index));
      }
   }
}
